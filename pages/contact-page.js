    ...
    <Layout title="Contact">
        <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
            ...
            <div className="mt-4">
                ...
                <p className="text-xs mt-2 text-gray-600">inpwjp@gmail.com</p>
            ...
            <div className="mt-6 flex justify-around">
                ...
                <div>
                    <a 
                        href="https://www.facebook.com/naoki.moriya.94"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                ...
                <div>
                    <a 
                        href="https://www.github.com/inpwjp"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
